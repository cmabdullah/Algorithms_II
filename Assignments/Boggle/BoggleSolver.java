...
➜  Boggle ls
BoggleBoard.class       BoggleSolver$Node.class board4x4.txt            boggle test
BoggleBoard.java        BoggleSolver.class      boggle                  dictionary-algs4.txt
BoggleSolver$1.class    BoggleSolver.java       boggle reject.zip
➜  Boggle rm *.class
➜  Boggle ls
BoggleBoard.java     board4x4.txt         boggle reject.zip    dictionary-algs4.txt
BoggleSolver.java    boggle               boggle test
➜  Boggle javac BoggleSolver.java
➜  Boggle javac-algs4 BoggleSolver.java
➜  Boggle checkstyle-algs4 BoggleSolver.java
Running checkstyle on BoggleSolver.java:
Starting audit...
BoggleSolver.java:0: Incorrect algs4.jar header format. [RegexpMultiline]
BoggleSolver.java:33:54: Do not use the ternary conditional operator in this course. [AvoidInlineConditionals]
BoggleSolver.java:98:72: Do not use the ternary conditional operator in this course. [AvoidInlineConditionals]
Audit done.
