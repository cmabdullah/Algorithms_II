...
//Note that, as of November 2017, the names of the methods in BurrowsWheeler changed from encode() and decode() to transform() and inverseTransform(), respectively.
